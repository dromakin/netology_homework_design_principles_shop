...
public interface InventoryUtil {
    ...
    Inventory addInventoryStock(Inventory inventory);

    Inventory sellInventoryStock(Inventory inventory);

    ProductRatingResponse buildProductRatingResponse(Inventory inventory);
